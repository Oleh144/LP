			...
			<Container maxW='container'>
				...
				<Flex
					...
					<ReactCard
						...
						body='Multistakeholder governance aligns employees with the organization’s wider community.'
					/>
					<ReactCard
						icon={workIcon02}
						title='Meritocratic by design'
						body='Tokenized ownership aligns deeply committed individuals with the organization’s success.'
					/>
					<ReactCard
						icon={workIcon03}
						title='Engineered for resilience'
						body='Open Enterprise supports best practices in sociocratic management.'
					/>
				</Flex>
			</Container>
		</Box>
